      ...
      >
        <div className="relative z-10">
          ...
          <h2 className="font-heading text-3xl font-bold text-background leading-tight tracking-tight mb-3">
            Your AI health
            <br />companion starts here.
          </h2>
          <p className="text-sm font-body text-background/50 max-w-xs leading-relaxed">
            Intelligent symptom analysis, drug safety checks, and emergency guidance — all powered by AI.
          </p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        ...
        >
          ...
          <p className="text-[13px] font-body text-muted-foreground mb-8">
            ...
            <Link to="/signin" className="text-foreground font-medium hover:underline underline-offset-2">
              Sign in
            </Link>
          </p>
          ...
          {/* Terms */}
          <p className="text-[10px] text-muted-foreground/50 font-body text-center mt-6 leading-relaxed">
            By creating an account, you agree to our{" "}
            <span className="text-muted-foreground underline underline-offset-2 cursor-pointer">Terms</span>{" "}
            and{" "}
            <span className="text-muted-foreground underline underline-offset-2 cursor-pointer">Privacy Policy</span>
          </p>
        </motion.div>
      </div>
    </div>
